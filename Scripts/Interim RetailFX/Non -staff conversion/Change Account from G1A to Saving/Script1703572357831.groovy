...
Mobile.tap(findTestObject('Global Account Page/dynamicText', [('text') : 'Global Access Account-i']), 0, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.verifyElementExist(findTestObject('Global Account Page/dynamicText', [('text') : 'Saving Account']), 0,
	FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.comment('GBP ' + roundedNumber2)
