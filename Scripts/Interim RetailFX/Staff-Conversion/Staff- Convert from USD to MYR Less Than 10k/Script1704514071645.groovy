...
//Mobile.verifyElementExist(findTestObject('Global Account Page/dynamicText', [('text') : 'MYR ' + roundedNumber]), 0, FailureHandling.CONTINUE_ON_FAILURE)
...
//Mobile.verifyElementExist(findTestObject('Global Account Page/dynamicText', [('text') : 'MYR ' + roundedNumber]), 5, FailureHandling.CONTINUE_ON_FAILURE)
...
//Mobile.verifyElementExist(findTestObject('General/android.widget.TextView - Conversion', [('text') : 'RM ' + roundedNumber]), 0, FailureHandling.CONTINUE_ON_FAILURE)
