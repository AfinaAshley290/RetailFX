...
Mobile.verifyElementExist(findTestObject('Global Account Page/dynamicText', [('text') : 'BDT - Bangladesh Taka']),0, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.verifyElementExist(findTestObject('Global Account Page/dynamicText', [('text') : 'CNY - Chinese Renminbi']),0, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.verifyElementExist(findTestObject('Global Account Page/dynamicText', [('text') : 'IDR - Indonesian Rupiah']),0, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.verifyElementExist(findTestObject('Global Account Page/dynamicText', [('text') : 'PHP - Philippines Peso']),0, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.verifyElementExist(findTestObject('Global Account Page/dynamicText', [('text') : 'THB - Thai Baht']),0, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.tap(findTestObject('Global Account Page/dynamicText', [('text') : 'USD - US Dollar']),20, FailureHandling.CONTINUE_ON_FAILURE)
