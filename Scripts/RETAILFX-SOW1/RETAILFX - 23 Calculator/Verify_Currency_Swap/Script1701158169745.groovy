...
Mobile.tap(findTestObject('General/android.widget.Image_SwapButton'), 0, FailureHandling.CONTINUE_ON_FAILURE)
...
println('this Received Amount :' + roundedNumber)

def currency_received = Mobile.getText(findTestObject('Currency_Calc/android.widget.TextView - Amount to receive'), 0, FailureHandling.CONTINUE_ON_FAILURE)

currency_rec = currency_received.replace(',', '')


Mobile.verifyMatch(currency_rec, roundedNumber, false)
