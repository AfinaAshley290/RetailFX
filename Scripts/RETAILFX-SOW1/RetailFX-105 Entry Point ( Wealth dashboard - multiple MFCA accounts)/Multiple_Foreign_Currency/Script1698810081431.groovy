...
def text_no = findTestData('Username_Password').getValue('Frequecy_Acc_No1', 1)
...
Mobile.tap(findTestObject('Object Repository/Multiple_Frequecy_Account/android.widget.ImageView'), 0)

'Tap on the Second Account'
Mobile.tap(findTestObject('Currency_Exchange_Page/Currency_AccNo_1', [('text') : findTestData('Username_Password').getValue(
                'Frequecy_Acc_No2', 1)]), 0)
