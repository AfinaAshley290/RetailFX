...
Mobile.setText(findTestObject('Dashboard_Login/Onboarding_Login/Username'), findTestData('Username_Password').getValue('Username', 6), 0)
...
def Acc_Number = findTestData('Username_Password').getValue('Account_Number', 6)
...
Mobile.tap(findTestObject('Dashboard_Login/Onboarding_Login/device_name_continue_button'), 0)
