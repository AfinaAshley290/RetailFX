...
Mobile.tap(findTestObject('Watchlist/android.widget.TextView - View All Accounts'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.waitForElementPresent(findTestObject('Watchlist/android.widget.TextView - ACCOUNTS'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.swipe(900, 300, 300, 300)

Mobile.tap(findTestObject('Watchlist/android.widget.TextView - WEALTH'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.waitForElementPresent(findTestObject('Watchlist/android.widget.ImageView - First Wealth Tab'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.tap(findTestObject('Watchlist/android.widget.ImageView - First Wealth Tab'), 0, FailureHandling.CONTINUE_ON_FAILURE)

'Watchlist navigation reached'
Mobile.tap(findTestObject('Watchlist/android.widget.TextView - Watchlist'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.waitForElementPresent(findTestObject('Watchlist/android.widget.Image - first watchlist tab'), 0, FailureHandling.CONTINUE_ON_FAILURE)

'Store currency for later use - X path is used here'
currency = Mobile.getText(findTestObject('Watchlist/android.widget.TextView - first watchlist tab currency'), 0, FailureHandling.CONTINUE_ON_FAILURE)
...
'X path is used here'
Mobile.tap(findTestObject('Watchlist/android.widget.Image - first watchlist tab'), 0, FailureHandling.CONTINUE_ON_FAILURE)

'Validate that the header Chart & News '
news_header = Mobile.getText(findTestObject('Object Repository/Watchlist/android.widget.TextView - Chart  News'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyMatch(news_header, 'Chart & News', false)

'Validate the currency is the same as the outer currency - X path used here'
displayed_cur = Mobile.getText(findTestObject('Object Repository/Watchlist/android.widget.TextView - Currency'), 0, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.verifyElementExist(findTestObject('Object Repository/Watchlist/android.view.View - First news tab'), 0, FailureHandling.CONTINUE_ON_FAILURE)
...
'Test for contact the bank'
Mobile.tap(findTestObject('Watchlist/android.widget.Image - Chart n News 3 dot btn'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.tap(findTestObject('Watchlist/android.view.View - Contact Bank - Chart n News'), 0, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.tap(findTestObject('Watchlist/android.widget.TextView - First news tab content'), 0, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.verifyNotMatch('full_news_content_l1', '', false, FailureHandling.CONTINUE_ON_FAILURE)

'Screenshot of the search full news page'
Mobile.takeScreenshot()

Mobile.tap(findTestObject('Object Repository/Watchlist/android.widget.Image - full news x btn'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.tap(findTestObject('Watchlist/android.widget.TextView - View All News'), 0, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.verifyElementExist(findTestObject('Object Repository/Watchlist/android.view.View - searched news tab 1'), 0, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.verifyNotMatch(news_header, '', false, FailureHandling.CONTINUE_ON_FAILURE)
...
'open up full news'
Mobile.tap(findTestObject('Watchlist/android.widget.TextView - First News tab header in search'), 0, FailureHandling.CONTINUE_ON_FAILURE)
...
if (news_header.contains(full_news_header))
{ 
	println(full_news_header + '=' + news_header)
}
