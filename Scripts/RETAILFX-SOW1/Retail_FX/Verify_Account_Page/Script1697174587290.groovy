...
'Tap on Foreign Currency Account'
...
Mobile.verifyElementExist(findTestObject('Landing_Page/android.widget.TextView - Foreign Currency _USD_dropdown'), 0)
...
Mobile.tap(findTestObject('Landing_Page/android.widget.TextView - Foreign Currency _USD_dropdown'), 0)
