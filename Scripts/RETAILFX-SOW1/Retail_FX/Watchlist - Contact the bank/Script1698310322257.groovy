...
Mobile.verifyMatch(contact_bank_header, 'Contact Bank', false)
...
Mobile.verifyMatch(contact_bank_call_now, 'Call Now', false)

Mobile.takeScreenshot()

Mobile.tap(findTestObject('Contact The Bank/android.widget.TextView - Call Now'), 0)
...
Mobile.verifyMatch(phone_number, '1300886688', false)

Mobile.takeScreenshot()

Mobile.tap(findTestObject('Object Repository/Contact The Bank/android.widget.Button - CANCEL'), 0)
