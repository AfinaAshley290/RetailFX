...
Mobile.verifyElementExist(findTestObject('Global Account Page/dynamicText', [('text') : 'Global Access Account-i']), 5, 
    FailureHandling.CONTINUE_ON_FAILURE)
...
numpad.remove_Amount(digits)

Mobile.delay(15)

digits1 = '6000'

numpad.Currency_Numpad(digits1)
