...
'TC033 - Verify the account'
Mobile.comment('TC033')

Mobile.verifyElementText(findTestObject('SOW2-Market Order/Global_access_Account_No'), findTestData('Username_Password').getValue('G1A_Account_No', 
                a))
